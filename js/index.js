        ...
        const markup = `
          <div class="col-sm d-flex">
            ...
            <div class="col-sm d-flex">
              ...
              <h3 class="card-text city-temp text-info">Atualmente: ${Math.round(main.temp)}<sup>°C</sup></h3>
              <h5 class="card-text city-temp text-info">Parece: ${Math.round(main.feels_like)}<sup>°C</sup></h5>
